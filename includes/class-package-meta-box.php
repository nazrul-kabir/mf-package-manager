...
class Package_Meta_Box {
    ...
    public function render_meta_box($post) {
        ...
        $fields = array(
            ...
            'min_download_speed' => __('Min Download Speed:', 'package-manager'),
            'max_download_speed' => __('Max Download Speed:', 'package-manager'),
            'min_upload_speed' => __('Min Upload Speed:', 'package-manager'),
            'max_upload_speed' => __('Max Upload Speed:', 'package-manager'),
            'technology' => __('Technology :', 'package-manager'),
    ...
    public function save_meta_box_data($post_id) {
        ...
        $fields = array(
            ...
            'min_download_speed' => 'sanitize_text_field',
            'max_download_speed' => 'sanitize_text_field',
            'min_upload_speed' => 'sanitize_text_field',
            'max_upload_speed' => 'sanitize_text_field',
            'extra_free' => 'sanitize_textarea_field',
            'technology' => 'sanitize_textarea_field',
